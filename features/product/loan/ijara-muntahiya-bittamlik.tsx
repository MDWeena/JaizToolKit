...
import { ijaraMuntahiyaBittamlikData } from "../data";
import { PageSection } from "@/types/page";


const IjaraMuntahiyaBittamlikScreen = () => {
  return (
    <SafeAreaView className="flex-1 bg-background">
      <BackButton />
      <ScrollView className="flex-1 px-5">
        <Header title="Ijara Muntahiya Bittamlik" />
        <FlatList<PageSection>
          data={ijaraMuntahiyaBittamlikData}
          renderItem={({ item }) => (
...
export default IjaraMuntahiyaBittamlikScreen;
