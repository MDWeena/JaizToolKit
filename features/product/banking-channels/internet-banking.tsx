...
import { internetBankingData } from "../data";
import { PageSection } from "@/types/page";

const InternetBankingScreen = () => {
  return (
    <SafeAreaView className="flex-1 bg-background">
      <BackButton />
      <ScrollView className="flex-1 px-5">
        <Header title="Internet Banking" />
        <FlatList<PageSection>
          data={internetBankingData}
          renderItem={({ item }) => (
...
export default InternetBankingScreen;
