...
export const tier1AccountData: PageSection[] = [
  ...
  },
  {
    ...
    content: [
      ...
      "Farmers.",
      "Socially and financially disadvantaged individuals.",
    ],
...
export const currentAccountData: PageSection[] = [
  {
    ...
    section: "Description",
    content: [
      `This account can be used by professionals for their monthly income. It is also used by individuals that require frequent transactions and flexible banking operations. The account allows for Cheque book to be issued to customers and also customers can be on boarded on.`,
    ],
    icon: <DocumentIcon width={32} height={32} />,
  },
  {
...
export const teenAccountData: PageSection[] = [
  ...
  },
  {
    id: 2,
    section: "Target Market",
    content: ["Guardians of minors.", "Parents and guardians.", "Teenagers."],
    icon: <TargetIcon width={32} height={32} />,
  },
  {
    id: 3,
...
export const corporateAccountData: PageSection[] = [
  {
    ...
    section: "Description",
    content: [
      `This caters for registered businesses, NGO and institutions seeking for banking services. This type of account can take the form of Registered company, Sole Proprietorship etc.`,
    ],
    icon: <DocumentIcon width={32} height={32} />,
  },
  {
...
export const verveCardData: PageSection[] = [
  {
    id: 1,
    section: "Target Market",
  ...
  },
  {
    ...
    section: "Features",
    content: [
      "Naira card (Domestic card).",
      "Can be used on ATM, POS and WEB.",
      "Retail product.",
      "It is linked to Interswitch, Quickteller, POS and Mobile Apps.",
      "Card is issued instantly.",
    ],
    icon: <DocumentIcon width={32} height={32} />,
  },
  {
    ...
    content: [
      "Wide accessibility.",
      "Cost effective, convenience reward and loyalty program.",
    ],
    icon: <DocumentIcon width={32} height={32} />,
  },
  {
...
export const visaDollarCardData: PageSection[] = [
  {
    id: 1,
    section: "Target Market",
    content: [
      "Individuals with savings or current account (Frequent travellers, Online shoppers,  students studying abroad, and HNIs).",
    ],
    icon: <TargetIcon width={32} height={32} />,
  },
  {
    ...
    content: [
      "Is a dollar Card.",
      "International acceptance on POS, ATM and WEB.",
      "It can be used for online cross-border transactions.",
      "Linked to a dollar account.",
    ],
    icon: <DocumentIcon width={32} height={32} />,
  },
  {
    ...
    content: [
      "Global usage.",
      "Travel convenience.",
      "Secure transactions and instant funding and access.",
    ],
    icon: <DocumentIcon width={32} height={32} />,
  },
  {
    ...
    section: "Documentation",
    content: [
      "Customer must have opened dollar/domiciliary account with the bank (full KYC must be taken during the opening of account).",
      "Fill card request form at the branch.",
    ],
    icon: <DocumentIcon width={32} height={32} />,
  },
...
export const masterCardData: PageSection[] = [
  {
    ...
    section: "Target Market",
    content: [
      "Premium and Premium plus Customers (Middle to high-income).",
      "Frequent travellers (local and international).",
      "Salary earners and professionals.",
      "Tech-savvy and lifestyle-oriented customers.",
      "Customers who shop or pay for services online.",
      "Customers seeking international transaction capability.",
    ],
    icon: <TargetIcon width={32} height={32} />,
  },
  {
    ...
    section: "Features",
    content: [
      "Multiple Channels: 24-hour access to funds via ATMs/POS/Web.",
      "Global Acceptance: Mastercard is accepted at Millions of locations worldwide, including retail stores, online merchants, ATMs etc.",
      "Can be used locally and internationally.",
      "Contactless Payment enabled.",
      "Convenience: Eliminates the risk and inconvenience of carrying cash.",
      "Dependable support: 24-hour access to support for all card-related complaints through our Contact Centre.",
  ...
  },
  {
    ...
    content: [
      ...
      "Our card is Chip and Pin secured.",
    ],
    icon: <DocumentIcon width={32} height={32} />,
  },
  {
...
export const afrigoCardData: PageSection[] = [
  {
    id: 1,
    section: "Target Market",
    content: ["Individuals with savings or current account."],
